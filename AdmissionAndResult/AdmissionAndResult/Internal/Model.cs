...
namespace SchemaMapper
{
    ...
    public class EntityContext : EntityBase
    {
        ...
        public EntityContext()
        {
            ...
            this.toEntitylist = Entities.ToList();
    ...
    {
        public List<Property> toPropertiesList { get; set; }
        public List<Relationship> toRelationshipsList  { get; set; }
        public List<Method> toMethodsList { get; set; }
        public Entity()
        {
            Properties = new PropertyCollection();
            this.toPropertiesList = Properties.ToList();
            Relationships = new RelationshipCollection();
            this.toRelationshipsList = Relationships.ToList();
            Methods = new MethodCollection();
            this.toMethodsList = Methods.ToList();
        }
    ...
    {
        List<Property> toPropertiesList;
        public Method()
        {
